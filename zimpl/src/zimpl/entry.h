...
/*lint -sem(        entry_new_numb, 1p == 1, @P > malloc(1P)) */
extern Entry*       entry_new_numb(const Tuple* tuple, const Numb* numb);
/*lint -sem(        entry_new_strg, nulterm(2), 1p == 1 && 2p, @P > malloc(1P)) */
extern Entry*       entry_new_strg(const Tuple* tuple, const char* strg);
/*lint -sem(        entry_new_set, 1p == 1 && 2p == 1, @P > malloc(1P)) */
extern Entry*       entry_new_set(const Tuple* tuple, const Set* set);
/*lint -sem(        entry_new_var, 1p == 1 && 2p == 1, @P > malloc(1P)) */
...
/*lint -sem(        entry_copy, 1p == 1, @P > malloc(1P)) */
...
/*lint -sem(        entry_get_tuple, 1p == 1, @P > malloc(1P)) */
...
/*lint -sem(        entry_get_set, 1p == 1, @P > malloc(1P)) */
extern const Set*   entry_get_set(const Entry* entry);
/*lint -sem(        entry_get_var, 1p == 1, @P > malloc(1P)) */
