...
public:
   ...
   ScipParaInitiator(
         ...
         :  ParaInitiator(inComm, inTimer), paraParams(0), instance(0), solution(0), scipDiffParamSetRoot(0), scipDiffParamSet(0), messagehdlr(0), logfile(0),
   ...
   bool tryToSetIncumbentSolution(UG::ParaSolution *sol, bool checksol);
