      ...
      stayAliveAfterInterrupt(false)
{
   ...
   messageHandler[TagTerminateSolvingToRestart] = &UG::ParaSolver::processTagTerminateSolvingToRestart;
   messageHandler[TagGivenGapIsReached] = &UG::ParaSolver::processTagGivenGapIsReached;
   messageHandler[TagTestDualBoundGain] = &UG::ParaSolver::processTagTestDualBoundGain;
   messageHandler[TagNoTestDualBoundGain] = &UG::ParaSolver::processTagNoTestDualBoundGain;
   messageHandler[TagNoWaitModeSend] = &UG::ParaSolver::processTagNoWaitModeSend;
   messageHandler[TagRestart] = &UG::ParaSolver::processTagRestart;
   ...
   {
      messageHandler[TagLbBoundTightenedIndex] = &UG::ParaSolver::processTagLbBoundTightened;
      messageHandler[TagUbBoundTightenedIndex] = &UG::ParaSolver::processTagUbBoundTightened;
   }
   messageHandler[TagCutOffValue] = &UG::ParaSolver::processTagCutOffValue;
      ...
      )
{
   ...
   if( EPSLE( sol->getObjectiveFuntionValue(), globalBestIncumbentValue, DEFAULT_NUM_EPSILON ) )
      ...
      )
{
   ...
   int exitSolerRequest;
   PARA_COMM_CALL(
         paraComm->receive( &exitSolerRequest, 1, ParaINT, source, TagInterruptRequest)
         );
...
int
ParaSolver::processTagTerminateSolvingToRestart(
      int source,
      int tag
      )
{
...
int
ParaSolver::processTagGivenGapIsReached(
      int source,
      int tag
      )
{
...
int
ParaSolver::processTagTestDualBoundGain(
      int source,
      int tag
      )
{
...
int
ParaSolver::processTagNoTestDualBoundGain(
      int source,
      int tag
      )
{
...
int
ParaSolver::processTagNoWaitModeSend(
      int source,
      int tag
      )
{
...
int
ParaSolver::processTagLbBoundTightened(
      int source,
      int tag
      )
{
...
int
ParaSolver::processTagUbBoundTightened(
      int source,
      int tag
      )
{
...
int
ParaSolver::processTagCutOffValue(
      int source,
      int tag
      )
{
      ...
      )
{
   if( !globalBestIncumbentSolution ||  
       ( globalBestIncumbentSolution 
         && EPSLT( sol->getObjectiveFuntionValue(), globalBestIncumbentSolution->getObjectiveFuntionValue(), eps ) ) )
   {
...
bool
ParaSolver::updateGlobalBestCutOffValue(
      double newValue
      )
{
      ...
      )
{
   if( globalBestIncumbentSolution  )
   {
      if( EPSLE(sol->getObjectiveFuntionValue(), globalBestIncumbentSolution->getObjectiveFuntionValue(),DEFAULT_NUM_EPSILON) )
      {
      ...
      )
{
   ...
   idelTimeToWaitAckCompletion += idleTime;
