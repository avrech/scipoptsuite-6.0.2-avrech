...
#ifndef __PARA_SOLVER_TERMINATION_STATE_MPI_H__
#define __PARA_SOLVER_TERMINATION_STATE_MPI_H__
...
class ParaSolverTerminationStateMpi : public ParaSolverTerminationState
{
   /** create ParaNode datatype */
   MPI_Datatype createDatatype();
public:
   /** default constructor */
   ParaSolverTerminationStateMpi(){}
   /** constructor */
   ParaSolverTerminationStateMpi(
...
#endif // __PARA_SOLVER_TERMINATION_STATE_MPI_H__
